...
<aside class="fixed left-0 top-0 z-40 flex h-screen w-20 flex-col overflow-hidden bg-sidebar">
    ...
    <nav class="flex flex-1 flex-col items-center justify-center gap-4">
        ...
        {{-- Briefcase / Offers --}}
        <a href="{{ route('offers.index') }}" class="flex h-10 w-10 items-center justify-center rounded-lg {{ request()->routeIs('offers.*') ? 'bg-accent text-white' : 'text-text-secondary' }} transition hover:bg-card hover:text-white" title="Offers">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
        </a>

        {{-- Briefcase / Offres (legacy) --}}
